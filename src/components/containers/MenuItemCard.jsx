...
export default function MenuItemCard({ item }) {
  ...
  return (
    <article className="h-[fit-content] group w-[330px] flex flex-col pb-[9px] mb-[70px] hover:pb-[29px] hover:bg-white rounded-[10px] hover:shadow-[0px 16px 24px rgba(56, 81, 114, 0.2)]">
