...
export default function HomeHeader() {
  ...
  return (
    <section style={content && { backgroundImage: `url(${heroBackground})` }} className="home-header ml-[9px] md:ml-[0px] xl:ml-auto bg-contain bg-no-repeat md:bg-right bg-right-top pt-[121px] flex flex-col-reverse md:flex-row items-center  md:justify-between md:pt-[127px] md:pb-[160px] md:pl-[53px] md:pr-[30px] xl:mt-[0px] xl:pt-[132px] xl:pb-[220px] xl:pl-[101px] xl:pr-[94px] max-w-[1500px] mx-auto">
      ...
      </header>
      {
        ...
        && (
          <>
            <img src={content.hamburgerMobile.data.attributes.url} alt="Hamburguer" className="md:hidden w-[83vw] mb-[64px] md:mb-[0px] md:w-[38vw] md:max-w-[312px] md:max-h-[246px] xl:max-w-[567px] xl:max-h-[30vw]" />
            <img src={content.hamburgerDesktop.data.attributes.url} alt="Hamburguer" className="hidden md:block w-[83vw] mb-[64px] md:mb-[0px] md:w-[41vw] md:max-w-[312px] md:max-h-[246px] lg:w-[38vw] xl:max-w-[567px] xl:max-h-[30vw]" />
          </>
        )
      }
    </section>
