...
export default function HomeHeader() {
  return (
    <section className="mt-[-84px] flex justify-between pt-[132px] pb-[220px] pl-[101px] pr-[94px] max-w-[1500px] mx-auto" style={homeHeroBackground}>
      <header className="w-[38vw] max-w-[579px]">
      ...
      <img src={heroHamburguer} alt="Hamburguer" className="w-[38vw] max-w-[567px] max-h-[30vw]" />
    </section>
  );
}
