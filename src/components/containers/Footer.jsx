...
export default function Footer() {
  return (
    <footer className="px-[8vw] mt-[20px] md:mt-[24px] mb-[48px] bg-[#f8f8f8] max-w-[1500px] mx-auto">
      <menu className="flex flex-col items-center gap-[18px] md:flex-row md:flex-wrap md:items-start md:gap-y-[15px] md:gap-x-[44px] font-Roboto font-normal text-[16px] leading-[28px] text-[#00000040]">
