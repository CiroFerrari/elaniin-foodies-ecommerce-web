...
export default function MenuFilterMobile(props) {
  ...
  return (
    ...
    >
      <p className="text-[#FFD600] font-Druk-Text-Wide font-bold text-[25px] leading-[25px] mb-[53px]">{filterTitle}</p>
      <button
        type="button"
      ...
      </button>
      {
        ...
        && (
          <div className="flex flex-col gap-[50px]">
            <button type="button" className={`text-left text-white font-Syne font-bold text-[25px] leading-[30px] ${(actualCategory === 'Todas') && 'underline underline-offset-[1px] decoration-[#FFD600] decoration-[6px]'}`} onClick={() => { handleCategoryFilter('Todas'); setShowMobileFilter(false); }}>{allCategoriesButtonText}</button>
