...
export default function BranchItem(props) {
  ...
  return (
    <button
      ...
      className={`flex flex-col items-start border-[1px] border-black border-solid rounded-[4px] px-[12px] md:px-[22px] py-[15px] mt-[10px] md:mt-[0px] lg:mt-[10px] md:my-[10px] ml-[16px] md:ml-[7vw] mr-[16px] md:mr-[22px] hover:text-[#00000050] md:max-w-[85vw] ${(selected === id) && 'bg-[#FFF1BF] border-none'}`}
    >
