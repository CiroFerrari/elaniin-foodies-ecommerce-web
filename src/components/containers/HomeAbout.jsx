  ...
  return (
    <section ref={ref} className="mt-[52px] md:mt-[80px] flex flex-col xl:flex-row max-w-[1500px] mx-auto">
      ...
      <article
        ...
        className="bg-contain xl:flex-1 bg-no-repeat bg-center pl-[16px] lg:bg-cover xl:bg-contain md:pt-[60px] md:pb-[52px] md:pl-[53px] xl:pt-[46px] xl:pb-[70px] xl:pl-[56px] flex flex-col justify-center"
      >
        {
          isVisible
          && (
